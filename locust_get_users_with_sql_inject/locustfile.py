import sys
sys.path.append("../service2/pyhtonPb")

from locust import User, task, between
import grpc

import get_users_with_sql_inject_pb2_grpc
import get_users_with_sql_inject_pb2
...
class GrpcUser(User):
    ...
    def get_user(self):
        ...
        request = get_users_with_sql_inject_pb2.GetDataRequest(user_id="1")
