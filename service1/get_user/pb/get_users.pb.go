...
type GetDataRequest struct {
	...
	AuthKey   int64  `protobuf:"varint,2,opt,name=auth_key,json=authKey,proto3" json:"auth_key,omitempty"`
...
func (x *GetDataRequest) GetAuthKey() int64 {
	if x != nil {
		return x.AuthKey
	}
	return 0
...
var file_get_users_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x4b, 0x65, 0x79, 0x12,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x67, 0x65, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72,
